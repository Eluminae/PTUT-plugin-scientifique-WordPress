<div id="post-<?php the_ID(); ?>" <?php post_class("blog-entry"); ?>>
    ...
    <div class="entry-content">
        <div class="entry-details">
            <ul>
                <li class="entry-details-comments"><a href="<?php the_permalink() ?>"><i class="icon-327"
                                                                                         title="<?php _ex('Comments', 'blog', 'sevenfold') ?>"></i>(<?php comments_number('0', '1', '%') ?>
                        )</a></li>
                <li class="entry-details-date"><?php the_time('d');
                    echo "<br>";
                    the_time('M') ?></li>
                ...
                <li class="entry-details-data">
                    <p><span><?php
                            ...
                            ?> <span
                                class="distance"><?php _e('Category', 'sevenfold'); ?></span> : <?php the_category(', '); ?>
                    </p>
                    <p class="entry-details-data-italic"><span><?php _e("Tags", "sevenfold") ?></span>
                        : <?php the_tags('', ', ', '') ?></p>
                </li>
            </ul>
        </div>
